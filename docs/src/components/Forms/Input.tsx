...
import { InputProps, PasswordInputProps, PhoneInputProps } from './Input.types';
...
const PasswordFormInput = React.forwardRef<TextInput, Omit<PasswordInputProps, 'type'>>((props, ref) => {
    ...
    return (
        <View style={[styles.input, styles.passwordContainer, props.errorText ? styles.inputError : null]}>
            <TextInput
                ref={ref}
...
const PhoneFormInput = React.forwardRef<TextInput, Omit<PhoneInputProps, 'type'>>((props, ref) => {
    ...
    return (
        <View style={styles.phoneContainer}>
            ...
            <TextInput
                ref={ref}
                style={[styles.input, styles.phoneInput, props.errorText ? styles.inputError : null]}
